  ...
  return (
    <div className="container">
      <Tabs defaultValue="negotiation" className="w-full">
        <TabsList>
          <TabsTrigger value="negotiation">Negociação pendente</TabsTrigger>
          <TabsTrigger value="budgeting">Criação de orçamento</TabsTrigger>
        </TabsList>
        <TabsContent value="negotiation" className="w-full">
        ...
        <TabsContent value="budgeting">Change your password here.</TabsContent>
      </Tabs>
    </div>
  )
}
